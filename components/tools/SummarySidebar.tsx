...
import { Youtube, FileText, Globe, Type, Plus, Send, Bot, User, Loader2, Mic, MicOff, Clock, BookOpen, FileEdit, Copy, Check, ChevronDown } from 'lucide-react'
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <button
                            ...
                            className="h-9 px-2 bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-lg flex items-center gap-1 text-xs font-medium hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-colors"
                        >
